...
import { PrismaScrappingRefreshStatusRepository } from './prisma/prisma-scrapping-refresh-status.repository'
...
@Module({
  ...
  providers: [
    ...
    { provide: ScrappingRefreshStatusRepository, useClass: PrismaScrappingRefreshStatusRepository },
  ],
  exports: [
    WorkRepository,
    BatchService,
    ...
    CalendarRepository,
    ScrappingRefreshStatusRepository,
  ],
})
