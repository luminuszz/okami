...
export class FetchForWorkersReadQueryHandler
  implements IQueryHandler<FetchForWorkersReadQuery>
{
  constructor(
    private readonly fetchForWorkersRead: FetchForWorkersReadUseCase,
  ) {}
